...
function sendEvent(e) {
    getTrackingCode() && window._CTR_IS_TRACKING_ENABLED && window.socketConnection && window.socketConnection.send(JSON.stringify(e))
}

function _EA_PUSH(e, t, n) {
    if (getTrackingCode() && window._CTR_IS_TRACKING_ENABLED) {
        var a = "https://ctrwow-prod-fingerprint-microservice.azurewebsites.net/api/CreateFunctionHttpTrigger?code=UaJqPA9RGvefKokk5Jt6CXObgyELuRwSLvpiGFZi6FtD//RXEBzcIg==&trackingId=" + getTrackingCode();
        "LOGIN" === e && clearSession();
        var i = getSession();
        if ("PAGEVIEW" === e) sendTrafficLogRequest(a, JSON.stringify({
            fingerprint: window._EA_ID,
            oldFp: window._EA_OLD_ID,
            ...
            fnName: e,
            args: t,
            customData: window._CTR_CUSTOM_DATA
        })), window._EA_START_TIME = new Date;
        else if ("ONUNLOAD" === e) {
            window._EA_END_TIME = new Date;
            var r = window._EA_END_TIME - window._EA_START_TIME;
            sendTrafficLogRequest(a, JSON.stringify({
                fingerprint: window._EA_ID,
                oldFp: window._EA_OLD_ID,
                variables: window._EA_VARS,
                location: window.location,
                ...
                customData: window._CTR_CUSTOM_DATA,
                args: {
                    timeSpentOnPageInMiliSeconds: r,
                    eventParams: t
                }
            })), window._EA_START_TIME = new Date
        } else n ? sendEvent({
        ...
        return "LOGOUT" === e && clearSession(), e
    }
}

function getClientId() {
    return getCookie("d_ctr_cid")
}

function setClientId(e) {
    e && setCookie("d_ctr_cid", e, 1051200)
}

function getTrackingCode() {
    return window._CTR_TRACKING_ID
}

function getSession() {
    var e = "d_ctr_sid" + getTrackingCode(),
        t = getCookie(e),
        n = !1;
    return t || (t = generateSessionId(), n = !0), setCookie(e, t, 30), {
        sessionId: t,
        isNewSession: n
    }
}
...
function clearSession() {
    setCookie("d_ctr_sid" + getTrackingCode(), "")
}

function generateSessionId() {
    var e = (new Date).getTime(),
        t = (1e9 * Math.random()).toFixed(0);
    return window._CTR_TRACKING_ID + "." + e + "." + t
}

function sendTrafficLogRequest(e, t) {
    if (getTrackingCode() && window._CTR_IS_TRACKING_ENABLED) try {
        if (!navigator.sendBeacon) {
            var n = new XMLHttpRequest;
            return n.open("POST", e), n.setRequestHeader("Content-Type", "application/json"), n.send(t), !0
        }
...
function populateBrowserVariables(e) {
    window._EA_VARS = e;
    for (var t = 0; t < window._EA_VARS.length; ++t) "canvas" === window._EA_VARS[t].key && (window._EA_VARS[t].value = "");
    window._EA_VARS.push({
        key: "referrer",
        value: document.referrer
    })
}! function(e, t, n) {
    "use strict";
    "function" == typeof define && define.amd ? define(n) : "undefined" != typeof module && module.exports ? module.exports = n() : t.exports ? t.exports = n() : t.CTRwowFp = n()
}(0, window, function() {
    "use strict";
    var t = function(e) {
        if (!(this instanceof t)) return new t(e);
        this.options = this.extend(e, {
            swfContainerId: "CTRwowfp",
    ...
    return t.prototype = {
        ...
        get: function(a) {
            ...
            this.fontsKey(e, function(e) {
                ...
                i.each(e, function(e) {
                    var t = e.value;
                    void 0 !== e.value.join && (t = e.value.join(";")), n.push(t)
                });
        ...
        deviceMemoryKey: function(e) {
            return this.options.excludeDeviceMemory || e.push({
                key: "device_memory",
            ...
            return setTimeout(function() {
                ...
                function e(e) {
                    for (var t = !1, n = 0; n < u.length; n++)
                        if (t = e[n].offsetWidth !== a[u[n]] || e[n].offsetHeight !== r[u[n]]) return t;
                    return t
                }
                var t = document.getElementsByTagName("body")[0],
                    ...
                    n = function() {
                        for (var e = [], t = 0, n = u.length; t < n; t++) {
                            var a = h();
                            a.style.fontFamily = u[t], i.appendChild(a), e.push(a)
                        }
                        return e
                    }();
                t.appendChild(i);
                for (var o = 0, s = u.length; o < s; o++) a[u[o]] = n[o].offsetWidth, r[u[o]] = n[o].offsetHeight;
                var l = function() {
                    for (var e, t, n, a = {}, i = 0, r = d.length; i < r; i++) {
                        for (var o = [], s = 0, l = u.length; s < l; s++) {
                            var c = (e = d[i], t = u[s], n = void 0, (n = h()).style.fontFamily = "'" + e + "'," + t, n);
                ...
                t.appendChild(g);
                for (var c = [], f = 0, p = d.length; f < p; f++) e(l[d[f]]) && c.push(d[f]);
                t.removeChild(g), t.removeChild(i), m.push({
                    key: "js_fonts",
                    value: c
                }), T(m)
            }, 1)
        ...
        getCanvasFp: function() {
            ...
            n.rect(0, 0, 10, 10), n.rect(2, 2, 6, 6), e.push("canvas winding:" + (!1 === n.isPointInPath(5, 5, "evenodd") ? "yes" : "no")), n.fillStyle = "rgb(255,0,255)", n.beginPath(), n.arc(75, 75, 75, 0, 2 * Math.PI, !0), n.arc(75, 75, 25, 0, 2 * Math.PI, !0), n.fill("evenodd"), n.beginPath(), n.arc(75, 75, 50, 0, 2 * Math.PI, !0), n.moveTo(110, 75), n.arc(75, 75, 35, 0, Math.PI, !1), n.moveTo(65, 65), n.arc(60, 65, 5, 0, 2 * Math.PI, !0), n.moveTo(95, 65), n.arc(90, 65, 5, 0, 2 * Math.PI, !0), n.stroke();
            var a = "$m@n@g& @n@LyT!c$";
        ...
        getWebglFp: function() {
            ...
            t.bufferData(t.ARRAY_BUFFER, i, t.STATIC_DRAW), a.itemSize = 3, a.numItems = 3;
            ...
            var s, l, c, u = t.createShader(t.FRAGMENT_SHADER);
        ...
        getHasLiedOs: function() {
            ...
            return 0 <= a.indexOf("win") && "Windows" !== e && "Windows Phone" !== e || ((0 <= a.indexOf("linux") || 0 <= a.indexOf("android") || 0 <= a.indexOf("pike")) && "Linux" !== e && "Android" !== e || ((0 <= a.indexOf("mac") || 0 <= a.indexOf("ipad") || 0 <= a.indexOf("ipod") || 0 <= a.indexOf("iphone")) && "Mac" !== e && "iOS" !== e || (0 === a.indexOf("win") && 0 === a.indexOf("linux") && 0 <= a.indexOf("mac") && "other" !== e || void 0 === navigator.plugins && "Windows" !== e && "Windows Phone" !== e)))
        },
        ...
        loadSwfAndDetectFonts: function(t) {
            ...
            swfobject.embedSWF(this.options.swfPath, n, "1", "1", "9.0.0", !1, a, {
        ...
        map: function(e, a, i) {
            var r = [];
            return null == e ? r : this.nativeMap && e.map === this.nativeMap ? e.map(a, i) : (this.each(e, function(e, t, n) {
        ...
        x64hash128: function(e, t) {
            t = t || 0;
            for (var n = (e = e || "").length % 16, a = e.length - n, i = [0, t], r = [0, t], o = [0, 0], s = [0, 0], l = [2277735313, 289559509], c = [1291169091, 658871167], u = 0; u < a; u += 16) o = [255 & e.charCodeAt(u + 4) | (255 & e.charCodeAt(u + 5)) << 8 | (255 & e.charCodeAt(u + 6)) << 16 | (255 & e.charCodeAt(u + 7)) << 24, 255 & e.charCodeAt(u) | (255 & e.charCodeAt(u + 1)) << 8 | (255 & e.charCodeAt(u + 2)) << 16 | (255 & e.charCodeAt(u + 3)) << 24], s = [255 & e.charCodeAt(u + 12) | (255 & e.charCodeAt(u + 13)) << 8 | (255 & e.charCodeAt(u + 14)) << 16 | (255 & e.charCodeAt(u + 15)) << 24, 255 & e.charCodeAt(u + 8) | (255 & e.charCodeAt(u + 9)) << 8 | (255 & e.charCodeAt(u + 10)) << 16 | (255 & e.charCodeAt(u + 11)) << 24], o = this.x64Multiply(o, l), o = this.x64Rotl(o, 31), o = this.x64Multiply(o, c), i = this.x64Xor(i, o), i = this.x64Rotl(i, 27), i = this.x64Add(i, r), i = this.x64Add(this.x64Multiply(i, [0, 5]), [0, 1390208809]), s = this.x64Multiply(s, c), s = this.x64Rotl(s, 33), s = this.x64Multiply(s, l), r = this.x64Xor(r, s), r = this.x64Rotl(r, 31), r = this.x64Add(r, i), r = this.x64Add(this.x64Multiply(r, [0, 5]), [0, 944331445]);
            switch (o = [0, 0], s = [0, 0], n) {
                ...
                case 9:
                    s = this.x64Xor(s, [0, e.charCodeAt(u + 8)]), s = this.x64Multiply(s, c), s = this.x64Rotl(s, 33), s = this.x64Multiply(s, l), r = this.x64Xor(r, s);
                case 8:
                ...
                case 1:
                    o = this.x64Xor(o, [0, e.charCodeAt(u)]), o = this.x64Multiply(o, l), o = this.x64Rotl(o, 31), o = this.x64Multiply(o, c), i = this.x64Xor(i, o)
            }
            return i = this.x64Xor(i, [0, e.length]), r = this.x64Xor(r, [0, e.length]), i = this.x64Add(i, r), r = this.x64Add(r, i), i = this.x64Fmix(i), r = this.x64Fmix(r), i = this.x64Add(i, r), r = this.x64Add(r, i), ("00000000" + (i[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (r[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (r[1] >>> 0).toString(16)).slice(-8)
        }
    }, t.VERSION = "1.5.1", t
}),
function(e, t, n) {
    "use strict";
    "undefined" != typeof window && "function" == typeof define && define.amd ? define(n) : "undefined" != typeof module && module.exports ? module.exports = n() : t.exports ? t.exports = n() : t.CTRwowFp2 = n()
}(0, this, function() {
    "use strict";
    ...
    function m(e) {
        return e = p(e, [0, e[0] >>> 1]), e = h(e, [4283543511, 3981806797]), e = p(e, [0, e[0] >>> 1]), e = h(e, [3301882366, 444984403]), e = p(e, [0, e[0] >>> 1])
    }

    function s(e, t) {
        t = t || 0;
        for (var n = (e = e || "").length % 16, a = e.length - n, i = [0, t], r = [0, t], o = [0, 0], s = [0, 0], l = [2277735313, 289559509], c = [1291169091, 658871167], u = 0; u < a; u += 16) o = [255 & e.charCodeAt(u + 4) | (255 & e.charCodeAt(u + 5)) << 8 | (255 & e.charCodeAt(u + 6)) << 16 | (255 & e.charCodeAt(u + 7)) << 24, 255 & e.charCodeAt(u) | (255 & e.charCodeAt(u + 1)) << 8 | (255 & e.charCodeAt(u + 2)) << 16 | (255 & e.charCodeAt(u + 3)) << 24], s = [255 & e.charCodeAt(u + 12) | (255 & e.charCodeAt(u + 13)) << 8 | (255 & e.charCodeAt(u + 14)) << 16 | (255 & e.charCodeAt(u + 15)) << 24, 255 & e.charCodeAt(u + 8) | (255 & e.charCodeAt(u + 9)) << 8 | (255 & e.charCodeAt(u + 10)) << 16 | (255 & e.charCodeAt(u + 11)) << 24], o = h(o, l), o = g(o, 31), o = h(o, c), i = p(i, o), i = g(i, 27), i = d(i, r), i = d(h(i, [0, 5]), [0, 1390208809]), s = h(s, c), s = g(s, 33), s = h(s, l), r = p(r, s), r = g(r, 31), r = d(r, i), r = d(h(r, [0, 5]), [0, 944331445]);
        switch (o = [0, 0], s = [0, 0], n) {
            case 15:
                s = p(s, f([0, e.charCodeAt(u + 14)], 48));
            case 14:
                s = p(s, f([0, e.charCodeAt(u + 13)], 40));
            case 13:
                s = p(s, f([0, e.charCodeAt(u + 12)], 32));
            case 12:
                s = p(s, f([0, e.charCodeAt(u + 11)], 24));
            case 11:
                s = p(s, f([0, e.charCodeAt(u + 10)], 16));
            case 10:
                s = p(s, f([0, e.charCodeAt(u + 9)], 8));
            case 9:
                s = p(s, [0, e.charCodeAt(u + 8)]), s = h(s, c), s = g(s, 33), s = h(s, l), r = p(r, s);
            case 8:
                o = p(o, f([0, e.charCodeAt(u + 7)], 56));
            case 7:
                o = p(o, f([0, e.charCodeAt(u + 6)], 48));
            case 6:
                o = p(o, f([0, e.charCodeAt(u + 5)], 40));
            case 5:
                o = p(o, f([0, e.charCodeAt(u + 4)], 32));
            case 4:
                o = p(o, f([0, e.charCodeAt(u + 3)], 24));
            case 3:
                o = p(o, f([0, e.charCodeAt(u + 2)], 16));
            case 2:
                o = p(o, f([0, e.charCodeAt(u + 1)], 8));
            case 1:
                o = p(o, [0, e.charCodeAt(u)]), o = h(o, l), o = g(o, 31), o = h(o, c), i = p(i, o)
        }
        return i = p(i, [0, e.length]), r = p(r, [0, e.length]), i = d(i, r), r = d(r, i), i = m(i), r = m(r), i = d(i, r), r = d(r, i), ("00000000" + (i[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (r[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (r[1] >>> 0).toString(16)).slice(-8)
    }
    ...
    function l(e, a) {
        var i = [];
        return null == e ? i : Array.prototype.map && e.map === Array.prototype.map ? e.map(a) : (c(e, function(e, t, n) {
            i.push(a(e, t, n))
        }), i)
    }
    ...
    var e = {
        ...
        u = function(t) {
            var e = [];
            if (Object.getOwnPropertyDescriptor && Object.getOwnPropertyDescriptor(window, "ActiveXObject") || "ActiveXObject" in window) {
                e = l(["AcroPDF.PDF", "Adodb.Stream", "AgControl.AgControl", "DevalVRXCtrl.DevalVRXCtrl.1", "MacromediaFlashPaper.MacromediaFlashPaper", "Msxml2.DOMDocument", "Msxml2.XMLHTTP", "PDF.PdfCtrl", "QuickTime.QuickTime", "QuickTimeCheckObject.QuickTimeCheck.1", "RealPlayer", "RealPlayer.RealPlayer(tm) ActiveX Control (32-bit)", "RealVideo.RealVideo(tm) ActiveX Control (32-bit)", "Scripting.Dictionary", "SWCtl.SWCtl", "Shell.UIHelper", "ShockwaveFlash.ShockwaveFlash", "Skype.Detection", "TDCCtl.TDCCtl", "WMPlayer.OCX", "rmocx.RealPlayer G2 Control", "rmocx.RealPlayer G2 Control.1"], function(e) {
                    try {
        ...
        M = function() {
            ...
            o.shaderSource(i, "attribute vec2 attrVertex;varying vec2 varyinTexCoordinate;uniform vec2 uniformOffset;void main(){varyinTexCoordinate=attrVertex+uniformOffset;gl_Position=vec4(attrVertex,0,1);}"), o.compileShader(i);
            var r = o.createShader(o.FRAGMENT_SHADER);
            o.shaderSource(r, "precision mediump float;varying vec2 varyinTexCoordinate;void main() {gl_FragColor=vec4(varyinTexCoordinate,0,1);}"), o.compileShader(r), o.attachShader(a, i), o.attachShader(a, r), o.linkProgram(a), o.useProgram(a), a.vertexPosAttrib = o.getAttribLocation(a, "attrVertex"), a.offsetUniform = o.getUniformLocation(a, "uniformOffset"), o.enableVertexAttribArray(a.vertexPosArray), o.vertexAttribPointer(a.vertexPosAttrib, t.itemSize, o.FLOAT, !1, 0, 0), o.uniform2f(a.offsetUniform, 1, 1), o.drawArrays(o.TRIANGLE_STRIP, 0, t.numItems);
            try {
            ...
            return o.getShaderPrecisionFormat && c(["FLOAT", "INT"], function(r) {
                c(["VERTEX", "FRAGMENT"], function(i) {
                    c(["HIGH", "MEDIUM", "LOW"], function(a) {
                        c(["precision", "rangeMin", "rangeMax"], function(e) {
                            var t = o.getShaderPrecisionFormat(o[i + "_SHADER"], o[a + "_" + r])[e];
                            "precision" !== e && (e = "precision " + e);
                            var n = ["webgl ", i.toLowerCase(), " shader ", a.toLowerCase(), " ", r.toLowerCase(), " ", e, ":", t].join("");
                            s.push(n)
                        })
                    })
                })
        ...
        b = function() {
            ...
            return 0 <= a.indexOf("win") && "Windows" !== e && "Windows Phone" !== e || ((0 <= a.indexOf("linux") || 0 <= a.indexOf("android") || 0 <= a.indexOf("pike")) && "Linux" !== e && "Android" !== e || ((0 <= a.indexOf("mac") || 0 <= a.indexOf("ipad") || 0 <= a.indexOf("ipod") || 0 <= a.indexOf("iphone")) && "Mac" !== e && "iOS" !== e || ((a.indexOf("win") < 0 && a.indexOf("linux") < 0 && a.indexOf("mac") < 0 && a.indexOf("iphone") < 0 && a.indexOf("ipad") < 0) != ("Other" === e) || void 0 === navigator.plugins && "Windows" !== e && "Windows Phone" !== e)))
        },
        O = function() {
            var e, t = navigator.userAgent.toLowerCase(),
                n = navigator.productSub;
        ...
        F = function(t, e) {
            ...
            window.swfobject.embedSWF(e.fonts.swfPath, a, "1", "1", "9.0.0", !1, i, {
                allowScriptAccess: "always",
                menu: "false"
            }, {})
        },
        ...
        H = [{
            ...
            key: "canvas",
            getData: function(e, t) {
                P() ? e(y(t)) : e(t.NOT_AVAILABLE)
            }
        }, {
            key: "webgl",
            getData: function(e, t) {
                L() ? e(M()) : e(t.NOT_AVAILABLE)
            }
        }, {
            ...
            getData: function(e, t) {
                ...
                function n(e) {
                    for (var t = !1, n = 0; n < u.length; n++)
                        if (t = e[n].offsetWidth !== r[u[n]] || e[n].offsetHeight !== o[u[n]]) return t;
                    return t
                }
                ...
                a.appendChild(i);
                for (var l = 0, c = u.length; l < c; l++) r[u[l]] = s[l].offsetWidth, o[u[l]] = s[l].offsetHeight;
                var f = function() {
                    for (var e, t, n, a = {}, i = 0, r = d.length; i < r; i++) {
                        for (var o = [], s = 0, l = u.length; s < l; s++) {
                            var c = (e = d[i], t = u[s], n = void 0, (n = h()).style.fontFamily = "'" + e + "'," + t, n);
                ...
                a.appendChild(g);
                for (var p = [], m = 0, T = d.length; m < T; m++) n(f[d[m]]) && p.push(d[m]);
                a.removeChild(g), a.removeChild(i), e(p)
            },
            pauseBefore: !0
        }, {
            key: "fontsFlash",
            getData: function(t, e) {
                return N() ? k() ? e.fonts.swfPath ? void F(function(e) {
                    t(e)
            ...
            getData: function(n, e) {
                ...
                }), r.connect(o), o.connect(i.destination), r.start(0), i.startRendering();
                var s = setTimeout(function() {
                    return i.oncomplete = function() {}, i = null, n("audioTimeout")
                }, t.timeout);
    ...
    return a.get = function(n, a) {
        ...
        var i = {
                ...
                addPreprocessedComponent: function(e, t) {
                    "function" == typeof n.preprocessor && (t = n.preprocessor(e, t)), i.data.push({
                        key: e,
                        value: t
                    })
                }
            ...
            r = -1,
            o = function(e) {
                if ((r += 1) >= n.components.length) a(i.data);
                else {
                    var t = n.components[r];
                    if (n.excludes[t.key]) o(!1);
                    else {
                        if (!e && t.pauseBefore) return r -= 1, void setTimeout(function() {
                            o(!0)
                        }, 1);
                        try {
                            t.getData(function(e) {
                                i.addPreprocessedComponent(t.key, e), o(!1)
                            }, n)
                        } catch (e) {
                            i.addPreprocessedComponent(t.key, String(e)), o(!1)
                        }
                    }
                }
            };
    ...
    }, a.getV18 = function(r, o) {
        return null == o && (o = r, r = {}), a.get(r, function(e) {
            for (var t = [], n = 0; n < e.length; n++) {
                var a = e[n];
                if (a.value === (r.NOT_AVAILABLE || "not available")) t.push({
                    key: a.key,
                    value: "unknown"
                });
                else if ("plugins" === a.key) t.push({
                    key: "plugins",
                    value: l(a.value, function(e) {
            ...
            var i = s(l(t, function(e) {
                return e.value
            }).join("~~~"), 31);
            o(i, t)
        })
    }, a.x64hash128 = s, a.VERSION = "2.1.0", a
}),
function(s) {
    s._EA_START_TIME = new Date, void 0 === s._CTR_IS_SPA && (s._CTR_IS_SPA = !1), void 0 === s._CTR_IS_TRACKING_ENABLED && (s._CTR_IS_TRACKING_ENABLED = !0), CTRwowFp2.get(function(e) {
        var r = CTRwowFp2.x64hash128(e.map(function(e) {
            return e.value
        }).join(), 31);
        populateBrowserVariables(e), (new CTRwowFp).get(function(e, t) {
            s._EA_ID = r, s._EA_OLD_ID = e;
            var n = getClientId();
            if (n && n !== s._EA_ID && (s._EA_OLD_ID = n), setClientId(s._EA_ID), s._CTR_FingerprintGeneratedCallback) try {
                s._CTR_FingerprintGeneratedCallback(s._EA_ID)
            } catch (e) {}
            if (!0 !== s._CTR_IS_SPA) {
                var a = "https://ctrwow-prod-fingerprint-microservice.azurewebsites.net/api/CreateLogHttpTrigger?code=X52ZQaDTSiyjsN334TNPrE34ReCoFvTXh7l0v8fT2knldk1LpP1fYw==&trackingId=" + getTrackingCode(),
                    i = getSession();
                sendTrafficLogRequest(a, JSON.stringify({
                    fingerprint: s._EA_ID,
                    oldFp: s._EA_OLD_ID,
                    variables: s._EA_VARS,
                    location: s.location,
                    sessionId: i.sessionId,
                    isNewSession: i.isNewSession,
                    type: "PAGEVIEW",
                    customData: s._CTR_CUSTOM_DATA
                }))
            }
        })
    }), s.WebSocket = s.WebSocket || s.MozWebSocket;
    var e = new WebSocket("wss://ctrwow-prod-analytics-socketserver.azurewebsites.net/?trackingId=" + getTrackingCode());
    e.onopen = function() {
        s.document.onclick = function(e) {
            for (var t = [], n = s.event ? s.event.srcElement : e.target, a = document.getElementsByTagName(n.tagName), i = 0; i < a.length; ++i)
                if (a[i] == n) {
                    var r = n.outerHTML;
                    "BODY" !== n.tagName && "HTML" !== n.tagName || (r = n.tagName), t.push({
                        tag: n.tagName,
                        index: i,
                        outerHTML: r,
                        id: n.id
        ...
        }, s.onbeforeunload = function(e) {
            s._EA_END_TIME = new Date;
            var t = s._EA_END_TIME - s._EA_START_TIME,
                n = getSession();
            sendEvent({
                type: "ONUNLOAD",
                args: {
                    timeSpentOnPageInMiliSeconds: t
                },
                fingerprint: s._EA_ID,
    ...
    }, e.onerror = function(e) {}, s.socketConnection = e
}(window);